...
def figure(title, n, *, cols=1, size=(11, 6.5)):
    ...
    fig.text(0.04, 0.885,
             f"YC: {number(n)} компаний, активных 13.07.2023. Статусы: августовская версия 2026.",
...
def boxplot(df):
    ...
    save_figure(fig,"06_team_size_boxplot",
                "Группы заданы статусом в августовской версии 2026. Скрипки: плотность на логарифмической шкале без значений "
